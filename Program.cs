    ...
    switch (menuSelection)
    {
        ...
        case "4":
            ...
            for (int i = 0; i < maxPets; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Physical description: tbd")
                    {
                        do
                        {
                    ...
                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Physical description: tbd")
                    {
                        do
                        {
            ...
            Console.WriteLine("\n\rNicknames and personality description fields are complete for all of our friends. \n\rPress the Enter key to continue");
            readResult = Console.ReadLine();
            break;
